                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="image">Image Form (High-Quality Screenshots - Top 50% of Page)</option>
                                        </select>
                                    </div>
                    ...
                    {jobStatus && jobStatus.status === 'completed' && (
                        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                            ...
                            <p className="text-green-600 text-xs mb-4">
                                Format: {pdfFormat === 'text' ? 'Text-based PDF' : 'High-Quality Image PDF with enhanced screenshots (Top 50% capture)'}
                            </p>
                ...
                <div className="max-w-2xl mx-auto">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center shadow-md">
                        ...
                        <div className="mt-2 text-xs text-blue-600">
                            Enhanced with Smart Connection Management & Ultra-High Quality Screenshots
                        </div>
                    </div>
                </div>
            </div>
